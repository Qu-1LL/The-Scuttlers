...
- The top-left settings button opens a rounded side panel for volume control and a music
  checkbox; changing volume snaps to fixed increments and previews the volume cue.
